...
def TweetsSearch(keyword, start_date, end_date, min_retweets=100, min_faves=100, item_num=1000):
...
# TweetsSearch('bitcoin','2022-2-26','2022-2-28',300,300)


def TweetUserRelevant(keyword, start_date, end_date, min_retweets=100, min_faves=100, item_num=1000):
    consumer_key = 'K3PCazIaerCRxhhnonBwgPtla'
    consumer_secret = 'xUHhL7WHolpwVonQpOONfWCd6XjulxO71rDFF4L1Ty2ubt5mVs'
    access_token = '1495603708045844482-lVmoLmBvY7iEyIkNNbMyp1sQf8KNwk'
    access_token_secret = 'zURZHZFRWR4rycrAmiKE9M4kayCTt4MlON5jW5iNf8bNO'
    ...
    try:
        ...
        tbt_user.sort_values(by='Counts').plot.barh(x='User',
                                                    y='Counts',
                                                    ax=ax,
                                                    color="purple")
        ...
        ex = 'Please check whether the keyword is entered correct or try to expand the scope of search.'
        tkinter.messagebox.askretrycancel("Warnings", ex)


#TweetUserRelevant('bitcoin','2022-2-28','2022-3-1',0,0,1000)
...
def TweetAnalyze(collection_word, keyword, start_date, end_date, min_retweets=100, min_faves=100, item_num=1000):
    consumer_key = 'K3PCazIaerCRxhhnonBwgPtla'
    consumer_secret = 'xUHhL7WHolpwVonQpOONfWCd6XjulxO71rDFF4L1Ty2ubt5mVs'
    access_token = '1495603708045844482-lVmoLmBvY7iEyIkNNbMyp1sQf8KNwk'
    access_token_secret = 'zURZHZFRWR4rycrAmiKE9M4kayCTt4MlON5jW5iNf8bNO'
...
def TweetCo_occurrence(collection_word, keyword, start_date, end_date, min_retweets=100, min_faves=100, item_num=1000):
    consumer_key = 'K3PCazIaerCRxhhnonBwgPtla'
    consumer_secret = 'xUHhL7WHolpwVonQpOONfWCd6XjulxO71rDFF4L1Ty2ubt5mVs'
    access_token = '1495603708045844482-lVmoLmBvY7iEyIkNNbMyp1sQf8KNwk'
    access_token_secret = 'zURZHZFRWR4rycrAmiKE9M4kayCTt4MlON5jW5iNf8bNO'
...
def TweetSentiment(keyword, start_date, end_date, min_retweets=100, min_faves=100, item_num=1000):
    consumer_key = 'K3PCazIaerCRxhhnonBwgPtla'
    consumer_secret = 'xUHhL7WHolpwVonQpOONfWCd6XjulxO71rDFF4L1Ty2ubt5mVs'
    access_token = '1495603708045844482-lVmoLmBvY7iEyIkNNbMyp1sQf8KNwk'
    access_token_secret = 'zURZHZFRWR4rycrAmiKE9M4kayCTt4MlON5jW5iNf8bNO'
...
# TweetSentiment('bitcoin', '2022-2-22', '2022-2-25', 200, 200)
