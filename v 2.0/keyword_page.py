...
def kw_people(userid, keyword):
    ...
    def kw_ppl_wordfre():
        ...
        TweetAnalyze(support, listDisp.get(tk.ACTIVE), sppl, date, date2, retweets, faves, max_ac)
...
def kw_technology(userid, keyword):
    ...
    blank_label7 = tk.ttk.Label(kw_tech_win).grid(row=15, column=0, rowspan=2, columnspan=12)

    setting_label = tk.ttk.Label(kw_tech_win, text='▼ Basic parameter settings ▼', font=("Times New Roman", 14, 'bold')) \
        .grid(row=17, column=2, rowspan=2, columnspan=3)
    ...
    date_label = tk.ttk.Label(kw_tech_win, text='Since', font=('calibre', 10, 'bold'))
    date_entry = DateEntry(kw_tech_win)

    date_label2 = tk.ttk.Label(kw_tech_win, text='Until', font=('calibre', 10, 'bold'))
    date_entry2 = DateEntry(kw_tech_win)

    retweets_label = tk.ttk.Label(kw_tech_win, text='Min Retweets', font=('calibre', 10, 'bold'))
    retweets_entry = tk.ttk.Entry(kw_tech_win, textvariable=retweets_var, font=('calibre', 10, 'normal'))
    retweets_var.set(100)

    faves_label = tk.ttk.Label(kw_tech_win, text='Min Favorites', font=('calibre', 10, 'bold'))
    faves_entry = tk.ttk.Entry(kw_tech_win, textvariable=faves_var, font=('calibre', 10, 'normal'))
    faves_var.set(100)

    max_ac_label = tk.ttk.Label(kw_tech_win, text='Max Acquisitions', font=('calibre', 10, 'bold'))
    max_ac_entry = tk.ttk.Entry(kw_tech_win, textvariable=max_ac_var, font=('calibre', 10, 'normal'))
    max_ac_var.set(300)

    include_label = tk.ttk.Label(kw_tech_win, text='Include Retweets', font=('calibre', 10, 'bold'))
    include_entry = tk.ttk.Combobox(kw_tech_win, textvariable=include_rt_var)
    include_entry['values'] = ('Yes', 'No')
    include_rt_var.set('No')

    support_label = tk.ttk.Label(kw_tech_win, text='Auxiliary Keywords', font=('calibre', 10, 'bold'))
    support_entry = tk.ttk.Entry(kw_tech_win, textvariable=support_var, font=('calibre', 10, 'normal'))
    support_var.set(keyword)
    ...
    search_btn = tk.ttk.Button(kw_tech_win, text='Search', command=kw_tech_search)
    search_btn.grid(row=15, column=6, rowspan=3, columnspan=4, sticky='nswe')

    user_btn = tk.ttk.Button(kw_tech_win, text='Most Relevant Users', command=kw_tech_user)
    user_btn.grid(row=19, column=6, rowspan=3, columnspan=4, sticky='nswe')

    wordfre_btn = tk.ttk.Button(kw_tech_win, text='Analyze Word Frequency   ', command=kw_tech_wordfre)
    wordfre_btn.grid(row=23, column=6, rowspan=3, columnspan=4, sticky='nswe')

    cooc_btn = tk.ttk.Button(kw_tech_win, text='Analyze Co-occurrence', command=kw_tech_cooc)
    cooc_btn.grid(row=27, column=6, rowspan=3, columnspan=4, sticky='nswe')

    sentiment_btn = tk.ttk.Button(kw_tech_win, text='Analyze Sentiment', command=kw_tech_sentiment)
    sentiment_btn.grid(row=31, column=6, rowspan=3, columnspan=4, sticky='nswe')

    blank_label8 = tk.ttk.Label(kw_tech_win).grid(row=33, column=0, rowspan=2, columnspan=12)
...
def kw_concept(userid, keyword):
    ...
    blank_label7 = tk.ttk.Label(kw_cpt_win).grid(row=15, column=0, rowspan=2, columnspan=12)

    setting_label = tk.ttk.Label(kw_cpt_win, text='▼ Basic parameter settings ▼', font=("Times New Roman", 14, 'bold')) \
        .grid(row=17, column=2, rowspan=2, columnspan=3)
    ...
    date_label = tk.ttk.Label(kw_cpt_win, text='Since', font=('calibre', 10, 'bold'))
    date_entry = DateEntry(kw_cpt_win)

    date_label2 = tk.ttk.Label(kw_cpt_win, text='Until', font=('calibre', 10, 'bold'))
    date_entry2 = DateEntry(kw_cpt_win)

    retweets_label = tk.ttk.Label(kw_cpt_win, text='Min Retweets', font=('calibre', 10, 'bold'))
    retweets_entry = tk.ttk.Entry(kw_cpt_win, textvariable=retweets_var, font=('calibre', 10, 'normal'))
    retweets_var.set(100)

    faves_label = tk.ttk.Label(kw_cpt_win, text='Min Favorites', font=('calibre', 10, 'bold'))
    faves_entry = tk.ttk.Entry(kw_cpt_win, textvariable=faves_var, font=('calibre', 10, 'normal'))
    faves_var.set(100)

    max_ac_label = tk.ttk.Label(kw_cpt_win, text='Max Acquisitions', font=('calibre', 10, 'bold'))
    max_ac_entry = tk.ttk.Entry(kw_cpt_win, textvariable=max_ac_var, font=('calibre', 10, 'normal'))
    max_ac_var.set(300)

    include_label = tk.ttk.Label(kw_cpt_win, text='Include Retweets', font=('calibre', 10, 'bold'))
    include_entry = tk.ttk.Combobox(kw_cpt_win, textvariable=include_rt_var)
    include_entry['values'] = ('Yes', 'No')
    include_rt_var.set('No')

    support_label = tk.ttk.Label(kw_cpt_win, text='Auxiliary Keywords', font=('calibre', 10, 'bold'))
    support_entry = tk.ttk.Entry(kw_cpt_win, textvariable=support_var, font=('calibre', 10, 'normal'))
    support_var.set(keyword)
    ...
    search_btn = tk.ttk.Button(kw_cpt_win, text='Search', command=kw_cpt_search)
    search_btn.grid(row=15, column=6, rowspan=3, columnspan=4, sticky='nswe')

    user_btn = tk.ttk.Button(kw_cpt_win, text='Most Relevant Users', command=kw_cpt_user)
    user_btn.grid(row=19, column=6, rowspan=3, columnspan=4, sticky='nswe')

    wordfre_btn = tk.ttk.Button(kw_cpt_win, text='Analyze Word Frequency   ', command=kw_cpt_wordfre)
    wordfre_btn.grid(row=23, column=6, rowspan=3, columnspan=4, sticky='nswe')

    cooc_btn = tk.ttk.Button(kw_cpt_win, text='Analyze Co-occurrence', command=kw_cpt_cooc)
    cooc_btn.grid(row=27, column=6, rowspan=3, columnspan=4, sticky='nswe')

    sentiment_btn = tk.ttk.Button(kw_cpt_win, text='Analyze Sentiment', command=kw_cpt_sentiment)
    sentiment_btn.grid(row=31, column=6, rowspan=3, columnspan=4, sticky='nswe')

    blank_label8 = tk.ttk.Label(kw_cpt_win).grid(row=33, column=0, rowspan=2, columnspan=12)
